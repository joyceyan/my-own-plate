...
Usage (legacy MLX pipeline):
    python mlx/train.py --train-data ~/src/my-own-plate/data/nutrition5k_hf
"""
...
def parse_args():
    ...
    parser.add_argument(
        "--output-dir", type=str,
        default="~/src/my-own-plate/training/mlx/output/adapters/adapters.safetensors",
